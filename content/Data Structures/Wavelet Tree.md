...
The [[Wavelet Tree]] is a data structure that maintains a sequence of $n$ integers $a_0,a_1,\dots,a_{n-1}\in\{0,1,\dots,2^m-1\}$ by maintaining the **Wavelet Matrix** of the sequence.
