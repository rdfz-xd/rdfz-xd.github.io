...
The [[Segment Tree]] is a data structure that maintains a sequence of $n=2^k$ numbers $a_0,a_1,\dots,a_{n-1}$ by maintaining $s(0,2^k),s(0,2^{k-1}),s(2^{k-1},2^k),\dots,s(0,1),s(1,2),\dots,s(2^k-1,2^k)$, where
$$
